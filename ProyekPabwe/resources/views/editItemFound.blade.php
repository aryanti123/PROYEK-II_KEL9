            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="lostform.html">Lost</a>
                        <a class="collapse-item active" href="foundform.html">Found</a>
                    </div>
                </div>
            </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12">
                            ...
                            <div class="row mb-3">
                                <label for="inputPassword3" class="col-sm-2 col-form-label">Owner</label>
                                <div class="col-sm-6">
                                    <input type="Owner" class="form-control" id="inputPassword3">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="inputPassword3" class="col-sm-2 col-form-label">Status</label>
                                <div class="col-sm-6">
                                    <input type="Status" placeholder="True/False" class="form-control" id="inputPassword3">
                                </div>
                            </div>
                            <div class="row mb-3">
