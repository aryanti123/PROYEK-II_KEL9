                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="nim" class="form-control" id="inputPassword3">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="inputPassword3" class="col-sm-2 col-form-label">Prodi</label>
                                <div class="col-sm-6">
                                    <input type="prodi" class="form-control" id="inputPassword3">
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="d-grid gap-2 d-md-flex col-8 justify-content-md-end">
                                <a class="btn btn-success" href="profilEdit.html" role="button">Edit</a>
                            </div>
                            </form>
                        </div>
                    </div>
