                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card bg-light bg-opacity-5">
                                        ...
                                        <div class="card-body text-center">
                                            <center><a href="allItemLost" class="btn text-light bg-primary">View All</a></center>
                                        </div>
                                    </div>
                                </div>
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card bg-light bg-opacity-5">
                                        ...
                                        <div class="card-body text-center">
                                            <center><a href="allItemFound" class="btn text-light bg-primary">View All</a></center>
                                        </div>
                                    </div>
                                </div>
                            </div>
