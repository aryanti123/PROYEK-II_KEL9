                                ...
                                <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    <img src="{{ asset('img/payung1.jpg') }}" class="card-img-top" alt="...">
                                                </center>
                                            </td>
                                            <td>-</td>
                                            <td>False</td>
                                            <td>
                                                <a class="btn btn-warning mb-2" href="editItemLost" role="button">Edit</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    <img src="{{ asset('img/botol.jpg') }}" class="card-img-top" alt="...">
                                                </center>
                                            </td>
                                            <td>-</td>
                                            <td>False</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    <img src="{{ asset('img/charger.jpg') }}" class="card-img-top" alt="...">
                                                </center>
                                            </td>
                                            <td>-</td>
                                            <td>False</td>
                                            <td>
                                                <a class="btn btn-warning mb-2" href="editItemFound" role="button">Edit</a>
                                                <button type="button" class="btn btn-danger">Delete</button>
                                            </td>
                                        </tr>
                                    </tbody>
