...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2021 at 10:46 PM
...
CREATE TABLE `barang` (
  ...
  `founderorowner` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'Alvin Monyet', NULL, NULL, 'alvin@gmail.com', NULL, 6);
...
--
ALTER TABLE `barang`
  ADD CONSTRAINT `barang_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id_users`);
